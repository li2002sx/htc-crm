...
$(function () {
    ...
    $('#save').click(function () {
        var params = {
            carDealerId: parseInt($('#carDealerId').val()) || 0,
            ...
            registTime: $('#registTime').val().trim(),
            expireTime: $('#expireTime').val().trim(),
            smsNum: parseInt($('#smsNum').val()) || 0,
        ...
        // if (params.registTime.length < 3) {
        //     $.err("注册时间不能为空");
        //     return false;
        // }
        // if (params.expireTime.length < 3) {
        //     $.err("到期时间不能为空");
        //     return false;
        // }
        // if (params.smsNum == 0) {
        ...
        $.post("/cardealer/save", params, function (result) {
            if (result.success) {
                $alert("提示", "保存成功！", function () {
                    location.href = "/cardealer/list";
                });
            } else {
