...
//        filterChainDefinitionMap.put("/adminuser/**","roles[admin]");
        List<String> adminRouters = Arrays.asList("list", "edit", "save", "delete", "resetpassword");
        adminRouters.forEach(item -> {
            filterChainDefinitionMap.put(String.format("/adminuser/%s", item), "roles[admin]");
        });
        filterChainDefinitionMap.put("/cartree/**", "roles[admin]");
        filterChainDefinitionMap.put("/cardealer/**", "roles[admin]");
        filterChainDefinitionMap.put("/carinfo/**", "roles[admin]");
...
//        filterChainDefinitionMap.put("/message", "anon");//anon 可以理解为不拦截
